...
var TodoFilterRadio = React.createClass({
    ...
    render: function () {
        ...
        return (
            ...
            <input type="radio" name="todoFilter" defaultChecked={(filter == "all") ? true : false} id={id} value={filter} onChange={this.handleChange} />
...
var TodoFilter = React.createClass({
    render: function () {
        return (
            ...
            <TodoFilterRadio filter="all" onFilterChange={this.props.onFilterChange} />
            <TodoFilterRadio filter="active" onFilterChange={this.props.onFilterChange} />
            <TodoFilterRadio filter="completed" onFilterChange={this.props.onFilterChange} />
            </div>
        )
    }
})
